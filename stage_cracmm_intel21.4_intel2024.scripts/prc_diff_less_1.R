...
inf.base <- nc_open("/work/users/l/i/lizadams/CMAQ/data/data/CCTM_ACONC_v54_intel21.4_2018_12US1_20171222.nc")
...
for (lay.sens in lay.sens.list) {
  ...
  for (spc in spc.list) {
    ...
    while (theDate <= endplotdate) {
      ...
      inf.base.file <- sprintf("/work/users/l/i/lizadams/CMAQ/data/data/CCTM_ACONC_v54_intel21.4_2018_12US1_%s.nc", plotdate)
      inf.sens.file <- sprintf("/work/users/l/i/lizadams/CMAQ/data/data/output_CCTM_v55_intel_STAGE_EM_2018_12US1_two_week_16x8/CCTM_ACONC_v55_intel_STAGE_EM_2018_12US1_two_week_16x8_%s.nc", plotdate)
