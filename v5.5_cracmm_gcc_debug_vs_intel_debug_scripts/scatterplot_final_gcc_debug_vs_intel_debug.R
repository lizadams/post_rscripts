...
endplotdate <- as.Date("20180701",format="%Y%m%d")
...
cctm.file1 <- sprintf("/proj/ie/proj/CMAS/CMAQ/CMAQv5.5_testing/CMAQ_v5.5/data/output_CCTM_v55_gcc_Bench_2018_12NE3_cracmm2_debug/CCTM_ACONC_v55_gcc_Bench_2018_12NE3_cracmm2_debug_%s.nc" ,plotdate)
cctm.file2 <- sprintf("/proj/ie/proj/CMAS/CMAQ/CMAQv5.5_testing/CMAQ_v5.5/data/CMAQv55_testing/CMAQ_Project/data/output_CCTM_v54_intel21.4_debug_Bench_2018_12NE3/CCTM_ACONC_v54_intel21.4_debug_Bench_2018_12NE3_%s.nc", plotdate)
...
for (lay.sens in lay.sens.list) {
  ...
  for (spc in spc.list) {
    ...
    plot_dir1 <- sprintf("/proj/ie/proj/CMAS/CMAQ/CMAQv5.5_testing/CMAQ_v5.5/POST/rscripts/v5.5_cracmm_gcc_debug_vs_intel_debug_scripts/plots_cracmm2_gcc_vs_intel_debug/base_%s/%s", base, lay.sens)
    plot_dir2 <- sprintf("/proj/ie/proj/CMAS/CMAQ/CMAQv5.5_testing/CMAQ_v5.5/POST/rscripts/v5.5_cracmm_gcc_debug_vs_intel_debug_scripts/plots_cracmm2_gcc_vs_intel_debug/prc_diff/base_%s/%s", base, lay.sens)
    plot_dir3 <- sprintf("/proj/ie/proj/CMAS/CMAQ/CMAQv5.5_testing/CMAQ_v5.5/POST/rscripts/v5.5_cracmm_gcc_debug_vs_intel_debug_scripts/plots_cracmm2_gcc_vs_intel_debug/m3diffout", base, lay.sens)
    ...
    png(sprintf("%s/prc_diff_vs_time_%s_%s.png", plot_dir2, spc, plotdate), res=150)
