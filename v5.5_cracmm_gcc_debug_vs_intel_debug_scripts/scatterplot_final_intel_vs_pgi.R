...
cctm.file1 <- sprintf("/proj/ie/proj/CMAS/CMAQ/CMAQv5.5_testing/CMAQ_v5.5/data/CMAQv55_testing/CMAQ_Project/data/output_CCTM_v54_intel21.4_debug_Bench_2018_12NE3/CCTM_ACONC_v54_intel21.4_debug_Bench_2018_12NE3_%s.nc" ,plotdate)
cctm.file2 <- sprintf("/proj/ie/proj/CMAS/CMAQ/CMAQv5.5_testing/CMAQ_v5.5/data/CMAQv55_testing/CMAQ_Project/data/output_CCTM_v54_pgi22.11_Bench_2018_12NE3/CCTM_ACONC_v54_pgi22.11_Bench_2018_12NE3_%s.nc", plotdate)
inf.base <- nc_open(cctm.file1)

sens.list2 <- c("")
sens.list3 <- c("")
sens.list <- c("v5.5_pgi")
...
for (lay.sens in lay.sens.list) {
  ...
  for (spc in spc.list) {
    ...
    plot_dir1 <- sprintf("/proj/ie/proj/CMAS/CMAQ/CMAQv5.5_testing/CMAQ_v5.5/POST/rscripts/v5.5_cracmm_intel_vs_pgi_scripts/plots_cracmm2_intel_vs_pgi/base_%s/%s", base, lay.sens)
    plot_dir2 <- sprintf("/proj/ie/proj/CMAS/CMAQ/CMAQv5.5_testing/CMAQ_v5.5/POST/rscripts/v5.5_cracmm_intel_vs_pgi_scripts/plots_cracmm2_intel_vs_pgi/prc_diff/base_%s/%s", base, lay.sens)
    plot_dir3 <- sprintf("/proj/ie/proj/CMAS/CMAQ/CMAQv5.5_testing/CMAQ_v5.5/POST/rscripts/v5.5_cracmm_intel_vs_pgi_scripts/plots_cracmm2_intel_vs_pgi/m3diffout", base, lay.sens)
