...
# Developed by Manish Soni and Liz Adams 07/17/2024
...
# Open one of the files to get the list of variables
...
plot_dir <- sprintf("/proj/ie/proj/CMAS/CMAQ/CMAQv5.5_testing/CMAQ_v5.5/POST/rscripts/v5.5_cracmm_gcc_debug_vs_intel_debug_scripts")
...
summary_file_path <- sprintf("%s/prc_summary_result_5.csv", plot_dir)
