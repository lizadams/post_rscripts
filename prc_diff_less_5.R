...
sens.list <- c("v5.4.0.1")
 ...
 inf.base <- nc_open("/proj/ie/proj/CMAS/CMAQ/CMAQv5.5_testing/CMAQ_v5.5/data/output_CCTM_v55_gcc_Bench_2018_12NE3_cracmm2/CCTM_ACONC_v55_gcc_Bench_2018_12NE3_cracmm2_20180701.nc")
...
endplotdate <- as.Date("2018-07-02", format="%Y-%m-%d")  # Changed end date for more columns

# Create directories if they don't exist
plot_dir <- sprintf("/proj/ie/proj/CMAS/CMAQ/CMAQv5.5_testing/CMAQ_v5.5/POST/rscripts")
...
for (lay.sens in lay.sens.list) {
  ...
  for (spc in spc.list) {
    ...
    while (theDate <= endplotdate) {
      ...
      inf.base.file <- sprintf("/proj/ie/proj/CMAS/CMAQ/CMAQv5.5_testing/CMAQ_v5.5/data/output_CCTM_v55_gcc_Bench_2018_12NE3_cracmm2/CCTM_ACONC_v55_gcc_Bench_2018_12NE3_cracmm2_%s.nc", plotdate)
      inf.sens.file <- sprintf("/proj/ie/proj/CMAS/CMAQ/CMAQv5.5_testing/CMAQ_v5.5/data/CMAQv55_testing/CMAQ_Project/data/output_CCTM_v54_intel21.4_Bench_2018_12NE3/CCTM_ACONC_v54_intel21.4_Bench_2018_12NE3_%s.nc", plotdate)
